...
1. **Facility onboarding** — Profile form writing the `facility_profiles` row (name, type, CAC number, address, FCT city/state, contact name). No document upload — facilities are verified by a manual admin check.
