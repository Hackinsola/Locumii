...
- **Auth flow — Steps 1–2 of 5 done.**
  ...
  - **Remaining steps (awaiting go-ahead):** (3) `src/hooks/useAuth.js`, (4) `src/pages/auth/{Register,Login,ForgotPassword}.jsx`, (5) React Router + role-based route guards. `react-router-dom` and `zustand` installed.
